...
class TrainConfig(NamedTuple):
    ...
    """
    #: train data 파일 경로
    train_path: str = "./dataset/nlu_tasks/nsmc/sample_train.tsv"
    #: test data 파일 경로
    dev_path: str = "./dataset/nlu_tasks/nsmc/sample_dev.tsv"
    #: test data 파일 경로
    test_path: str = "./dataset/nlu_tasks/nsmc/sample_test.tsv"
    #: output dir
